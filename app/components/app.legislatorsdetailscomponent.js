System.register(['angular2/core', '../services/MyLocalIGADataService', '../models/Legislator', 'angular2/router', './app.legislatureimage', './app.legislatureimagesmall', 'rxjs/add/operator/map'], function(exports_1, context_1) {
    "use strict";
